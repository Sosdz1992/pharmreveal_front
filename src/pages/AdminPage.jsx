...
const AdminPage = () => {
    ...
    const fetchUserAccess = async (id) => {
        ...
        try {
            const [res1, res2, res3, res4, res5, res6, res7, res8, res9, res10,res11,res12,res13,res14,res15,res16,res17,res18] = await Promise.all([
                ...
                axios.get(`/api/user-access/reference/year?userId=${id}`),
            ]);
            ...
            setYear(res18.data.map(opt => opt.id))
        } catch (e) {
